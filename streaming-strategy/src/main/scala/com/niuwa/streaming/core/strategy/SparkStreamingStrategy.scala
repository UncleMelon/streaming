package com.niuwa.streaming.core.strategy

import java.util

import com.niuwa.streaming.dispatcher.{Compositor, ParamsValidator, Processor, Strategy}
import org.apache.log4j.Logger

import scala.collection.JavaConversions._

class SparkStreamingStrategy[T] extends Strategy[T] {
